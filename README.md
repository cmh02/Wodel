...
The Wodel Project is an architecture and service for building highly-personalized machine learning to analyze and predict strength training workout trends.

## Why Wodel?

The problem with many existing services for machine learning and artificial intelligence approaches to understanding strenght building performance is limited by the generalization of trends across users. Instead of relating the model's intelligence to a specific user's performance, it attempts to map the user's performance to an unrelated understanding.
